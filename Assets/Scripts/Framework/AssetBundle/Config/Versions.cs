...
namespace AssetBundles
{
    public class Versions
    {
        ...
        public IEnumerator LoadLocalVersions()
        {
            ...
            Logger.LogError("本地资源 =="+versionTxt);
            LoadTempVersionHash();
        }
        ...
        private bool LoadTempVersionHash()
        {
            ...
            if (!string.IsNullOrEmpty(versionTxt))
            {
                Logger.LogError("LoadTempVersionHash =="+versionTxt);
        ...
        public IEnumerator LoadServerVersion(bool isInternal=false)
        {
            ...
            request.Dispose();
            Logger.LogError("服务器资源 =="+versionTxt);
        ...
        public int CompareVersions(ref List<string> updateList)
        {
            ...
            Logger.LogError(string.Format("updateList count = {0}", updateList.Count));
            return size;
        }
