...
namespace AssetBundles
{
    public partial class AssetBundleManager : MonoSingleton<AssetBundleManager>
    {
        ...
        {
            Logger.LogError("********** AssetbundleUpdater : Call TestHotfix in cs...");
        }
        #endregion
        ...
        public IEnumerator Initialize()
        {
            ...
            //判断沙盒目录是否有Assetbundles,如果没有则读取StreamingAssets目录下的Assetbundles
            //Assetbundles包含所有资源的依赖关系
            var manifestRequest = RequestAssetBundleAsync(manifest.AssetbundleName);
            //assetsmap_bytes.assetbundle
