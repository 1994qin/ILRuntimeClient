...
namespace AssetBundles
{
    ...
    public class AssetBundleMenuItems
    {
        ...
        static void CheckSimulateModelEnv()
        {
            ...
            Logger.Log("mainfest输出路径== {0}",outputManifest);
        ...
        [MenuItem("AssetBundles/TestAB",false,1304)]
        static public void aaa()
        {
            UnityEditor.BuildAssetBundleOptions buildOption = UnityEditor.BuildAssetBundleOptions.IgnoreTypeTreeChanges | UnityEditor.BuildAssetBundleOptions.DeterministicAssetBundle;
            AssetBundleManifest manifest = UnityEditor.BuildPipeline.BuildAssetBundles("Assets/ABs", buildOption, UnityEditor.BuildTarget.Android);
           // AssetBundleManifest manifest =  UnityEditor.BuildPipeline.BuildAssetBundles( "Assets/ABs", BuildAssetBundleOptions.None, BuildTarget.StandaloneWindows );
            Debug.LogError(manifest);
        }
        [MenuItem("AssetBundles/ClearEditorPrefs",false,1305)]
